...
describe('translations', () => {
  ...
  it.each(['de', 'fr', 'en'])('contains the complete primary workflow in %s', async (language) => {
    ...
    for (const key of ['appName', 'upload', 'layersTitle', 'locationStart', 'fileLocal', 'warning3d', 'alignNorth', 'objectDetails', 'hideObject', 'hideLayer', 'showHidden', 'hideTexts', 'showTexts', 'cadVisibility', 'openDrawer', 'closeDrawer', 'switchToMlight', 'switchToLegacy', 'cadControlsTitle', 'openCadControls', 'dwgFile', 'cadDisplay', 'basemapOff', 'basemapToggle', 'hideBasemap', 'showBasemap', 'gpsAccuracy', 'mlightProgress.finalizing']) {
