...
- 2D-Modellbereich mit Linien, Polylinien, Bögen, Kreisen, Ellipsen, Splines, Punkten, Texten und rekursiven Blöcken
...
- reale Lagegenauigkeit muss noch mit einer bereitgestellten LUREF-DWG abgenommen werden

Weitere Informationen: [Architektur](docs/architecture.md), [Netlify](docs/netlify.md), [Tests](docs/testing.md) und [Release 0.1.0](docs/releases/0.1.0.md).
