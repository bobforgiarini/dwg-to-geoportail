...
- gesamten unteren Bedienbereich als mobilen Drawer aus- und wieder einblenden
- alle CAD-Texte mit einer Kartenaktion gemeinsam aus- oder einblenden
...
- eingeblendete Copyright-, Versions- und Quellcodeinformation über `site-info-banner`
...
Weitere Informationen: [Architektur](docs/architecture.md), [Netlify](docs/netlify.md), [Tests](docs/testing.md) und [Release 0.1.3](docs/releases/0.1.3.md).
